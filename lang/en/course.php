...
$string['target:noaccesssincecoursestartinfo'] = 'Students who have not accessed the course yet';
$string['target:noaccesssincecoursestartinfo_help'] = 'The following students are enroled in a course which has started, but they have never accessed the course.';
...
$string['target:norecentaccessesinfo'] = 'Students who have not accessed the course recently';
$string['target:norecentaccessesinfo_help'] = 'The following students have not accessed a course they are enrolled in within the set analysis interval (by default the past month).';
...
$string['target:noteachingactivityinfo'] = 'Courses at risk of not starting';
$string['target:noteachingactivityinfo_help'] = 'The following courses due to start in the upcoming days are at risk of not starting because they don\'t have teachers or students enroled';
