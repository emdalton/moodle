...
$string['indicator:potentialcognitivedef_help'] = 'The degree to which the course offers "deep" cognitive engagement, e.g. submission of work for feedback, the opportunity to review work by others, and the opportunity to revise and resubmit work.  <a href ="{$a}Learning_analytics_indicators#Cognitive_depth">more</a>';
...
$string['indicator:potentialsocialdef_help'] = 'The degree to which the course offers "broad" social engagement, interacting with other participants and with the community of practice beyond the class.  <a href ="{$a}Learning_analytics_indicators#Social_breadth">more</a>';
