...
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the Survey activities during this analysis interval (Levels = No view, View, Submit) <a href="{$a}Learning_analytics_indicators#Cognitive_depth">more</a>';
...
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the Survey activities during this analysis interval (Levels = No participation, Participant alone) <a href="{$a}Learning_analytics_indicators#Social_breadth">more</a>';
